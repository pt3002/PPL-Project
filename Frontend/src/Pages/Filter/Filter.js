...
const Filter = (props) => {
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/placesunder20k')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/places20-40k')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/places40-60k')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/places60-100k')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/placesover100k')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/rating1')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/rating2')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/rating3')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/rating4')
    ...
    useEffect(() => {
        axios.get('https://travelarena.herokuapp.com/rating5')
